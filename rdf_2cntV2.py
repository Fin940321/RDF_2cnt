...
print(f"Total simulation time: {total_frames * 0.02:.2f} ps")  # Assuming 20 fs per frame
...
framestart=total_frames // 2  # Start from the middle of the trajectory
frameend=len(u.trajectory)-1

# set the atoms for computing RDF
resname1='Tf2'
atoms1=('Otf','Otf1','Otf2','Otf3')
